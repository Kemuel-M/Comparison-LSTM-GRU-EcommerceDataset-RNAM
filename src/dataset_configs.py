...
DATASET_CONFIGS = {
    'demand_forecasting': {
        ...
        'data_dir': config.PROJECT_ROOT / "data" / "demand-forecasting-kernels-only",
    ...
    'predict_future_sales': {
        ...
        'data_dir': config.PROJECT_ROOT / "data" / "Predict-Future-Sales-Translated-Dataset",
        'train_file': 'sales_train.csv',  # Este arquivo parece estar faltando no momento
        'test_file': 'test.csv',
        'date_column': 'date',
